...
function GenerateDocument() {
    ...
    let url = urlGenerateDocument + "?IdIntegridad=" + idIntegridad + "&ItemIntegridadDet=" + itemIntegridad + "&idDocumentFile=5";
    $.ajax({
        url: url,
        type: 'GET',
        dataType: 'json',
    ...
    if (camposVacios != "") {
        ...
        Swal.queue([{
            ...
            preConfirm: () => {
                ...
                return $.ajax({
                    type: "POST",
                    url: urlSaveorUpdateIntegrity180PlusColombia,
                    data: formData,
                    dataType: 'json',
                    cache: false,
                    contentType: false,
...
// --
function getList180PlusColombia() {
    // --
    ...
    // --
    let url = urlGetRiskAnalysisFormat180PlusColombia + "?IdIntegridad=" + idIntegridad + "&ItemIntegridadDet=" + Item
    // --
    $.ajax({
        type: "GET",
        url: url,
