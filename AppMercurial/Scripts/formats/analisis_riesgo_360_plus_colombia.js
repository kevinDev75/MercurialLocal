...
function GenerateDocument() {
    ...
    let url = urlGenerateDocument + "?IdIntegridad=" + idIntegridad + "&ItemIntegridadDet=" + itemIntegridad + "&idDocumentFile=7";
    $.ajax({
        url: url,
        type: 'GET',
        dataType: 'json',
...
$('#btn_3_10_agregar').on('click', function () {
    ...
    if (file_1_11 !== undefined) {
        ...
        if (ext1_11.toLowerCase() == "pdf") {
            // --
            formData.append("dataFile", file_1_11, "Anexo." + ext1_11);
        }
    }
    ...
    if (file_2_1_pdf !== undefined) {
        ...
        if (ext2_1_factor_oscuro.toLowerCase() == "pdf") {
            // --
    ...
    if (file_3_9_firma !== undefined) {
        ...
        // --
        if (ext_3_9_firma.toLowerCase() == "img" || ext_3_9_firma.toLowerCase() == "png" || ext_3_9_firma.toLowerCase() == "jpg" || ext_3_9_firma.toLowerCase() == "jpeg") {
            // --
    ...
    if (file_3_10_foto_entrada_domicilio !== undefined) {
        ...
        // --
        if (ext3_10_foto_entrada_domicilio.toLowerCase() == "img" || ext3_10_foto_entrada_domicilio.toLowerCase() == "png" || ext3_10_foto_entrada_domicilio.toLowerCase() == "jpg" || ext3_10_foto_entrada_domicilio.toLowerCase() == "jpeg") {
            // --
    ...
    if (file_3_10_foto_ambiente_social !== undefined) {
        ...
        // --
        if (ext3_10_foto_ambiente_social.toLowerCase() == "img" || ext3_10_foto_ambiente_social.toLowerCase() == "png" || ext3_10_foto_ambiente_social.toLowerCase() == "jpg" || ext3_10_foto_ambiente_social.toLowerCase() == "jpeg") {
            // --
    ...
    if (file_3_10_foto_habitaciones !== undefined) {
        ...
        // --
        if (ext3_10_foto_habitaciones.toLowerCase() == "img" || ext3_10_foto_habitaciones.toLowerCase() == "png" || ext3_10_foto_habitaciones.toLowerCase() == "jpg" || ext3_10_foto_habitaciones.toLowerCase() == "jpeg") {
            // --
    ...
    if (file_3_10_foto_cocina !== undefined) {
        ...
        // --
        if (ext3_10_foto_cocina.toLowerCase() == "img" || ext3_10_foto_cocina.toLowerCase() == "png" || ext3_10_foto_cocina.toLowerCase() == "jpg" || ext3_10_foto_cocina.toLowerCase() == "jpeg") {
            // --
    ...
    if (camposVacios != "") {
        ...
        Swal.queue([{
            ...
            preConfirm: () => {
                ...
                return $.ajax({
                    type: "POST",
                    url: urlSaveorUpdateIntegrity360PlusColombia,
                    data: formData,
                    dataType: 'json',
                    cache: false,
                    contentType: false,
...
// --
function getList360PlusColombia() {
    let idIntegridad = getDatos("key")
    let Item = getDatos("item")
    // --
    let url = urlGetRiskAnalysisFormat360PlusColombia + "?IdIntegridad=" + idIntegridad + "&ItemIntegridadDet=" + Item
    // --
    $.ajax({
        type: "GET",
        url: url,
