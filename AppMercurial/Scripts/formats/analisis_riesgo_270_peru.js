...
$('#btn_guardar').on('click', function () {
    ...
    // --
    var txt_6_analisis_test_confiabilidad = $("#txt_6_analisis_test_confiabilidad").val()

    // --
    var txt_7_direccion = $("#txt_7_direccion").val()
    var txt_7_fecha_entrevista = formatSaveDefault($("#txt_7_fecha_entrevista").val())
    ...
    let objectData = {
        ...
        "oAnalysisReliabilityTestFlt": {
            ...
            "IdIntegridad": idIntegridad,
            "ItemIntegridadDet": itemIntegridad,
            "Analisis": txt_6_analisis_test_confiabilidad
        },
    ...
    if (statusFirstValidation) {
        ...
        // --
        if (txt_6_analisis_test_confiabilidad == "") {
            camposVacios += "<span>VI. ANÁLISIS DE TEST DE CONFIABILIDAD</span>"
        }
        // --
        if (txt_7_direccion == "" ||
        ...
        if (camposVacios != "") {
            ...
            Swal.queue([{
                ...
                preConfirm: () => {
                    ...
                    return $.ajax({
                        type: "POST",
                        url: urlSaveorUpdateIntegrity270Peru,
                        data: formData,
                        dataType: 'json',
                        cache: false,
                        contentType: false,
...
function getList270Peru() {
    // --
    let idIntegridad = getDatos("key")
    let Item = getDatos("item")
    // --
    let url = urlGetRiskAnalysisFormat270Peru + "?IdIntegridad=" + idIntegridad + "&ItemIntegridadDet=" + Item
    var urlUsuario = urlWorkIntegrityDetail + "?IdIntegridad=" + idIntegridad; 
        ...
        success: function (data) {
            ...
            if (obj.oPersonalDataEvaluatedVm != null) {
                ...
                if (obj.oAnalysisReliabilityTestVm != null) {
                    // --
                    $("#txt_6_analisis_test_confiabilidad").val(obj.oAnalysisReliabilityTestVm.Analisis)
                }
                ...
                if (obj.oHouseCallsAnalysisVm != null) {
                    ...
                    $("#txt_7_fecha_entrevista").val(changeFormatInputDate(obj.oHouseCallsAnalysisVm.FechaEntrevista))
...
function GenerateDocument() {
    ...
    let url = urlGenerateDocument + "?IdIntegridad=" + idIntegridad + "&ItemIntegridadDet=" + itemIntegridad + "&idDocumentFile=13";
    // --
    $.ajax({
        url: url,
        type: 'GET',
