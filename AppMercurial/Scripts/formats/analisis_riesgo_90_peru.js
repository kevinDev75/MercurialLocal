        ...
        if (camposVacios != "") {
            ...
            Swal.queue([{
                ...
                preConfirm: () => {
                    ...
                    return $.ajax({
                        type: "POST",
                        url: UrlSaveorUpdateIntegrity90Peru,
                        data: formData,
                        dataType: 'json',
                        cache: false,
                        contentType: false,
                        ...
                        success: function (data) {
                            // --
                            console.log("Ver que error pasa")
                            console.log(data)
...
function saveFirstTime(data) {
    ...
    // --
    var txt_4_financiero_sentienel = $("#txt_4_financiero_sentienel").val()
    console.log(txt_4_financiero_sentienel);
    // --
    var txt_7_direccion = $("#txt_7_direccion").val()
    var txt_7_fecha_entrevista = SendDateTimeLocal($("#txt_7_fecha_entrevista").val())
    var txt_7_hora_entrevista = $("#txt_7_hora_entrevista").val()
    ...
    let objectData = {
        ...
        "oBasicInformationEvaluatedFlt": {
            ...
            "NombresApellidos": data.NombreCompleto,
            "IdTipoDocIdentidad": validateNumber(sl_vd_1_tipo_documento),
            "NumDocIdentidad": data.NroDocumento,
            "Lugar_FecNacimiento": txt_vd_1_lugar_fecha_nacimento,
            "Edad": validateNumber(txt_vd_1_edad),
            "Direccion": txt_vd_1_direccion,
            "Telefonos": txt_vd_1_telefonos,
...
function getList360PlusPeru() {
    ...
    // --
    let url = UrlGetRiskAnalysisFormat90Peru + "?IdIntegridad=" + idIntegridad + "&ItemIntegridadDet=" + Item
    var urlUsuario = urlWorkIntegrityDetail + "?IdIntegridad=" + idIntegridad; 
    // --
    $.ajax({
        type: "GET",
        ...
        success: function (data) {
            ...
            if (obj.oPersonalDataEvaluatedVm != null) {
                if (obj.oPersonalDataEvaluatedVm != null) {
                    ...
                    // la funcion .replace hace que cambio algo por otra cosa ,pero solo una vez
                ...
                if (obj.oBasicInformationEvaluatedVm != null) {
                    ...
                    console.log(obj.oBasicInformationEvaluatedVm.FechaVisita)
...
function GenerateDocument() {
    ...
    let url = urlGenerateDocument + "?IdIntegridad=" + idIntegridad + "&ItemIntegridadDet=" + itemIntegridad + "&idDocumentFile=9";
    $.ajax({
        url: url,
        type: 'GET',
        dataType: 'json',
...
// Se comento para  poner otro formato de fecha
