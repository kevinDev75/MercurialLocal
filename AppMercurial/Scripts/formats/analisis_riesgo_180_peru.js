...
$('#btn_guardar').on('click', function () {
    ...
    console.log(txt_1_fecha_expedicion);
    console.log("caducidad");
    console.log(txt_1_caducidad);
    ...
    if (statusFirstValidation) {
        ...
        if (txt_6_analisis_test_confiabilidad == "") {
            camposVacios += "<span>VI. ANÁLISIS DEL TEST FACTOR DE CONFIABILIDAD</span>"
        }
        // --
        if (txt_7_direccion == "" ||
...
function GenerateDocument() {
    ...
    let url = urlGenerateDocument + "?IdIntegridad=" + idIntegridad + "&ItemIntegridadDet=" + itemIntegridad + "&idDocumentFile=11";
    // --
    $.ajax({
        url: url,
        type: 'GET',
