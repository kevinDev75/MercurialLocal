...
$("#btn_1_7_agregar").on('click', function () {
    ...
    if (
        ...
        let object = {
            ...
            "MontoPagosPendientes": validateNumber(txt_1_7_monto_pagos_pendientes),
        }
...
$("#btn_1_8_agregar").on('click', function () {
    ...
    if (
        ...
        let object = {
            ...
            "MontoPagosPendientes": validateNumber(txt_1_8_monto_pagos_pendientes),
        }
...
$("#btn_1_9_agregar").on('click', function () {
    ...
    if (
        ...
        let object = {
            ...
            "ImporteAdeudado": validateNumber(txt_1_9_importe_adecuado),
...
$("#btn_1_10_agregar").on('click', function () {
    ...
    if (
        ...
        let object = {
            ...
            "ImporteAdeudado": validateNumber(txt_1_10_importe_adecuado),
...
$("#btn_1_11_agregar_lineas_credito").on('click', function () {
    ...
    if (
        ...
        let object = {
            ...
            "TotalLineaCredito": validateNumber(txt_1_11_total_linea_credito),
        }
...
$("#btn_1_11_agregar_detalle_deuda").on('click', function () {
    ...
    if (
        ...
        let object = {
            ...
            "Capital": validateNumber(txt_1_11_capital),
            "InteresComisiones": validateNumber(txt_1_11_intereses_comisiones),
            "DeudaTotal": validateNumber(txt_1_11_deuda_total),
        }
...
$('#btn_3_10_agregar').on('click', function () {
    ...
    var nameFichaReniec = $('#file_1_5_imagen').val().split('\\').pop();
    var extensionFichaReniec = functions.getFileExtension(nameFichaReniec)
    if (file_1_5_imagen !== undefined) {
        // --
        let ext1_5 = getFileExtension(file_1_5_imagen.name)
        // --
        if (ext1_5 == "img" || ext1_5 == "png" || ext1_5 == "jpg" || ext1_5 == "jpeg") {
            // --
            formData.append("dataFile", file_1_5_imagen, "fichaReniec");
        }
    }
    ...
    if (camposVacios != "") {
        ...
        Swal.queue([{
            ...
            preConfirm: () => {
                ...
                return $.ajax({
                    type: "POST",
                    url: urlSaveorUpdateIntegrity180Plus,
                    data: formData,
                    dataType: 'json',
                    cache: false,
                    contentType: false,
