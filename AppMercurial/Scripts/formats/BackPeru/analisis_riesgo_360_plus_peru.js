...
// -- VERIFICACIÓN SUNAT
var formData1_16_imagen = new FormData();
// -- IMG
var file_1_16_imagen = $('#file_1_16_imagen').prop("files")[0];
if (file_1_16_imagen !== undefined) {
    // --
    let ext1_16_foto_candidatos = getFileExtension(file_1_16_imagen.name)
    // --
    if (ext1_16_foto_candidatos == "img" || ext1_16_foto_candidatos == "png" || ext1_16_foto_candidatos == "jpg" || ext1_16_foto_candidatos == "jpeg") {
        // --
        formData1_16_imagen.append("imagen", file_1_16_imagen);
    }
}


// -- VERIFICACIÓN RECORD DEL CONDUCTOR
var formData1_17_imagen = new FormData();
// -- IMG
var file_1_17_imagen = $('#file_1_17_imagen').prop("files")[0];
if (file_1_17_imagen !== undefined) {
    // --
    let ext1_17_foto_candidatos = getFileExtension(file_1_17_imagen.name)
    // --
    if (ext1_17_foto_candidatos == "img" || ext1_17_foto_candidatos == "png" || ext1_17_foto_candidatos == "jpg" || ext1_17_foto_candidatos == "jpeg") {
        // --
        formData1_16_imagen.append("imagen", file_1_17_imagen);
    }
}
...
$('#btn_3_10_agregar').on('click', function () {
    ...
    var objectData = {
        ...
        "oJobPerformanceFlt": {
            "IdDesempenoLaboral": 0,
            "IdIntegridad": idIntegridad,
            "ItemIntegridadDet": itemIntegridad,
            "NombreEmpresa": txt_1_21_nombre_empresa,
            "CargoDesempenado": txt_1_21_cargo_desempenado,
            "FechaInicio": formatSave(txt_1_21_fecha_inicio),
            "FechaTerminacion": formatSave(txt_1_21_fecha_termino),
        ...
        "oEconomicInformationFlt": {
            ...
            "TotalIngresos": txt_3_6_ingresos_mensuales_total_ingresos,
            "TotalEgresos": txt_3_6_gastos_mensuales_total_egresos,
            "ListEconomicInformationDetailFlt": [
                {
                    "IdInfoEconomica": 0,
                    "ItemInfoEconomica": 0,
                    "IngresosMensuales": "Ingresos Fijos",
                    "ValorIngresoMensual": txt_3_6_ingresos_mensuales_ingresos_fijos,
                    "GastosMensuales": "Gastos Fijos",
                    "ValorGastoMensual": txt_3_6_gastos_mensuales_gastos_fijos
                },
                {
                    "IdInfoEconomica": 0,
                    "ItemInfoEconomica": 0,
                    "IngresosMensuales": "Apoyo Económico",
                    "ValorIngresoMensual": txt_3_6_ingresos_mensuales_apoyo_economico,
                    "GastosMensuales": "Créditos",
                    "ValorGastoMensual": txt_3_6_gastos_mensuales_creditos
                },
                {
                    "IdInfoEconomica": 0,
                    "ItemInfoEconomica": 0,
                    "IngresosMensuales": "Otros Ingresos",
                    "ValorIngresoMensual": txt_3_6_ingresos_mensuales_otros_ingresos,
                    "GastosMensuales": "Otros Gastos",
                    "ValorGastoMensual": txt_3_6_gastos_mensuales_valor
                }
            ],
        },
        // --
