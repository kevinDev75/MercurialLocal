        ...
        if (camposVacios != "") {
            ...
            Swal.queue([{
                ...
                preConfirm: () => {
                    ...
                    return $.ajax({
                        type: "POST",
                        url: UrlSaveorUpdateIntegrity90PlusPeru,
                        data: formData,
                        dataType: 'json',
                        cache: false,
                        contentType: false,
...
function getList90PlusPeru() {
    // --
    let idIntegridad = getDatos("key")
    let Item = getDatos("item")
    // --
    let url = UrlGetRiskAnalysisFormat90PlusPeru + "?IdIntegridad=" + idIntegridad + "&ItemIntegridadDet=" + Item
    var urlUsuario = urlWorkIntegrityDetail + "?IdIntegridad=" + idIntegridad; 
    // --
    $.ajax({
        type: "GET",
...
function GenerateDocument() {
    ...
    let url = urlGenerateDocument + "?IdIntegridad=" + idIntegridad + "&ItemIntegridadDet=" + itemIntegridad + "&idDocumentFile=10";
    $.ajax({
        url: url,
        type: 'GET',
        dataType: 'json',
