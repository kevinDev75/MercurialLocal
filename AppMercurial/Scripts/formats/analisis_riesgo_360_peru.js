        ...
        success: function (data) {
            ...
            if (obj.oPersonalDataEvaluatedVm != null) {
                ...
                if (obj.oBasicInformationEvaluatedVm != null) {
                    ...
                    $("#txt_vd_1_fecha_visita").val(obj.oBasicInformationEvaluatedVm.FechaVisita)
                ...
                if (obj.oEconomicInformationVm != null) {
                    ...
                    $('#sl_vd_4_bienes_comerciales').val((obj.oEconomicInformationVm.CtaBienesComerciales != null ? obj.oEconomicInformationVm.CtaBienesComerciales.toLowerCase() : 'false'));
...
function GenerateDocument() {
    ...
    let url = urlGenerateDocument + "?IdIntegridad=" + idIntegridad + "&ItemIntegridadDet=" + itemIntegridad + "&idDocumentFile=15";
    $.ajax({
        url: url,
        type: 'GET',
        dataType: 'json',
